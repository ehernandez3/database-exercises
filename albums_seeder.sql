...
VALUES ('Michael Jackson', 'Thriller', '1982', 47.3, 'Pop, rock, R&B'),
       ...
       ('Fleetwood Mac', 'Rumours', '1982', 27.9, 'Soft rock'),
       ...
       ('Alanis Morissette', 'Jagged Little Pill', '1995', 24.4, 'Soft'),
       ('Shania Twain', 'Come On Over', '1997', 29.6, 'Country, pop'),
       ('Celine Dion', 'Falling into You', '1996', 20.2, 'Pop, soft rock'),
       ('The Beatles', 'Sgt. Pepper''s Lonely Hearts Club Band', '1967', 18.2, 'Alternative rock'),
